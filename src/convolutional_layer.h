...
typedef layer16 convolutional_layer16;

void add_bias16(FLT *output, FLT *biases, int batch, int n, int size);
void add_bias16vec(FLT *output, FLT *biases, int batch, int n, int size);
...
void forward_convolutional_layer16(const convolutional_layer16 layer, network16 net);
