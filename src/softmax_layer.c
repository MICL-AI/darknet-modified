...
softmax_layer16 make_softmax_layer16(int batch, int inputs, int groups)
{
    ...
    l.inputs = inputs;
    l.outputs = inputs;
    l.output = calloc(inputs*batch, sizeof(FLT));//liuj 20180713
    l.delta = calloc(inputs*batch, sizeof(FLT));//liuj

    l.forward = forward_softmax_layer16;
    return l;
}
softmax_layer16 make_softmax_layerCJ16(int batch, int inputs, int groups)
{
    ...
    l.forward = forward_softmax_layerCJ16;
    return l;
}
...
{
	if (net.flag_vec==0)
		softmax_cpu16(net.input, l.inputs/l.groups, l.batch, l.inputs, l.groups, l.inputs/l.groups, 1, l.temperature, l.output);
	else
		/*softmax_cpu_vec16(net.input, l.inputs/l.groups, l.batch, l.inputs, l.groups, l.inputs/l.groups, 1, l.temperature, l.output);
                                               */
             ;
}
...
{
       printf("forward_softmax_layer16\n"); printf("####temperature:%f\n",(FLT)l.temperature);
       softmax_cpu16(net.input, l.inputs/l.groups, l.batch, l.inputs, l.groups, l.inputs/l.groups, 1, l.temperature, l.output);
