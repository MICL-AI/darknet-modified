...
typedef struct sparse_matrix
{
    ...
    count_t dst_col, dst_row;   //partation parameter
    count_t num_col, num_row;   //my shape
    count_t idx_col, idx_row;   //my index within partation
